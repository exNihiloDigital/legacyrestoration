...
function enqueue_theme()
{
    if (! is_admin()) {
        ...
        wp_enqueue_script('theme', get_template_directory_uri() . '/assets/theme.min.js', array(), $js_v, true);
        ...
        wp_enqueue_style('theme', get_template_directory_uri() . '/assets/theme.min.css', array(), $css_v);
    }
}
